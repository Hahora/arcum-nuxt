  ...
  >
    ...
    <div class="relative mx-auto max-w-4xl px-6 text-center z-10">
      ...
      >
        ...
        <span class="text-gray-300">Клининг Ростов-на-Дону</span>
      </div>
      ...
      >
        Профессиональный клининг в Ростове-на-Дону
      </span>
      ...
      <div class="grid grid-cols-3 gap-6 max-w-xl mx-auto">
        ...
        <div class="text-center">
          <Icon
            ...
            class="w-7 h-7 mx-auto text-cyan-400 mb-2"
          />
          <p class="text-sm font-semibold">Ростов-на-Дону</p>
        </div>
      </div>
    </div>
    ...
    <CallbackModal
      ...
      :preselectedService="'cleaning-rostov'"
...
const handleCallbackSubmit = (formData) => {
  console.log("Форма отправлена из Hero секции клининга:", formData);
};
