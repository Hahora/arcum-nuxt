  ...
  >
    ...
    <div class="relative mx-auto max-w-4xl px-6 text-center z-10">
      ...
      >
        ...
        <span class="text-gray-300">Фасады</span>
      </div>
      ...
      >
        Профессиональная мойка фасадов
      </span>
      ...
      >
        Работаем в Ростове-на-Дону, Таганроге, Батайске, Аксае.
      </p>
...
const handleCallbackSubmit = (formData) => {
  console.log("Форма отправлена из Hero секции мойки фасадов:", formData);
};
