    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="text-center mb-14">
        ...
        <p class="text-gray-600 text-lg max-w-2xl mx-auto">
          Посмотрите реальные примеры уборки до и после — мы действительно
          делаем чисто.
        </p>
      </div>
...
const items = reactive([
  {
    ...
    description: "Глубокая очистка обивки, удаление пятен и запахов.",
    before: "/images/furniture-before-after/a4.webp",
    after: "/images/furniture-before-after/b4.webp",
    slider: 50,
  },
  {
    id: 2,
    ...
    before: "/images/furniture-before-after/a2.webp",
    after: "/images/furniture-before-after/b2.webp",
    slider: 50,
  },
  {
    id: 3,
    title: "Чистка матраса",
    description: "Удаление пылевых клещей и глубокая дезинфекция.",
    before: "/images/furniture-before-after/a3.webp",
    after: "/images/furniture-before-after/b3.webp",
    slider: 50,
  },
]);
