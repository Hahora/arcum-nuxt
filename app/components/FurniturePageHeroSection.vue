  ...
  >
    ...
    <div class="relative mx-auto max-w-4xl px-6 text-center z-10">
      ...
      >
        ...
        <span class="text-gray-300">Химчистка Ростов-на-Дону</span>
      </div>
      ...
      >
        Профессиональная химчистка в Ростове-на-Дону
      </span>
      ...
      >
        ...
        <span class="text-cyan-400">Аркум</span>
      </h1>
      ...
      >
        Химчистка мебели на дому, в кратчайшие сроки наведём чистоту
      </p>
    ...
    <CallbackModal
      ...
      :preselectedService="'furniture-rostov'"
...
const handleCallbackSubmit = (formData) => {
  console.log("Форма отправлена из Hero секции химчистки Ростова:", formData);
};
