  ...
  >
    ...
    <div class="relative mx-auto max-w-4xl px-6 text-center z-10">
      ...
      >
        ...
        <span class="text-gray-300">Химчистка Ростовская область</span>
      </div>
      ...
      >
        Профессиональная химчистка в Ростовской области
      </span>
    ...
    <CallbackModal
      ...
      :preselectedService="'furniture-region'"
...
const handleCallbackSubmit = (formData) => {
  console.log("Форма отправлена из Hero секции химчистки области:", formData);
};
