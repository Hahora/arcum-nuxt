  ...
  >
    ...
    <div class="relative mx-auto max-w-4xl px-6 text-center z-10">
      ...
      >
        ...
        <span class="text-gray-300">Уборка для организаций</span>
      </div>
      ...
      >
        Профессиональная уборка для организаций
      </span>
      ...
      >
        ...
        уборка помещений в Ростове-на-Дону и области
      </h1>
      ...
      >
        Убираем квартиры, офисы и предприятия — быстро, аккуратно и с гарантией
        качества.
      </p>
    ...
    >
      <img src="/images/main1.webp" class="w-full h-full object-cover" />
    </div>

    <div
      class="absolute right-0 top-0 h-full w-[20%] hidden lg:block opacity-15"
    >
      <img src="/images/main2.webp" class="w-full h-full object-cover" />
    </div>

    <!-- Модальное окно обратного звонка с предвыбранной услугой -->
    <CallbackModal
...
const handleCallbackSubmit = (formData) => {
  console.log("Форма отправлена из Hero секции услуг:", formData);
  // Проверяем, что выбрана правильная услуга
  if (formData.service === "b2b") {
    console.log("Выбрана услуга: Уборка для организаций");
  }
};
